...
client.on("message", async (msg) => {
  ...
  if (msg.body > 0 && msg.body <= 9) {
    ...
    if (msg.body !== null && msg.body === "1" && msg.from.endsWith("@c.us")) {
      ...
      await client.sendMessage(
        msg.from,
        "Si tienes otra pregunta digita otro número según la opción deseada, o escribe AYUDA para que una persona pueda atenderte." +
          "😎\n\nElige uno de los numeros del menu:\n\n1- Curso de conduccion de motocicleta.\n2- Curso de conduccion de automovil particular.\n3-*Doble Curso de conduccion de motocicleta y automovil*\n4- Curso de conduccion de automovil publico.\n5- Refrendacion licencia.\n6- Horarios.\n7- Formas de pago.\n8- Ubicacion\n*9Me intereza ¿cual es el paso a seguir?*\n0- AYUDA"
      );
    }
    ...
    if (msg.body !== null && msg.body === "5" && msg.from.endsWith("@c.us")) {
      ...
      await client.sendMessage(
        msg.from,
        " La refrendación consta de un examen medico en el CRC Certifimed por valor de $219.000, lo puedes pagar aqui o directamente en el CRC, luego ir a la oficina de transito de su eleccion a imprimir la licencia"
      );
      await chat.sendStateTyping();
      await delay(5000);
      await client.sendMessage(
    ...
    if (
      (msg.body !== null && msg.body === "0") ||
      msg.body === "AYUDA" ||
      msg.body === "Ayuda" ||
      (msg.body === "ayuda" && msg.from.endsWith("@c.us"))
    ) {
      const chat = await msg.getChat();
      await chat.sendStateTyping();
      await delay(5000);
      await client.sendMessage(
        msg.from,
        "Acabamos de informar a uno de nuestros asesores para ayudarte, favor espera un momento"
      );
    }
  }
  // Si el número no está en el rango, enviar un mensaje de error
    ...
    await client.sendMessage(
      msg.from,
      "Favor digite uno de los números del menú (1 al 9)."
    );
  }
  ...
  client.on("message", async (msg) => {
    if (
      msg.body.toLowerCase() === "salir" ||
      msg.body.toLowerCase() === "Gracias" ||
      msg.body.toLowerCase() === "gracias" ||
      msg.body.toLowerCase() === "adios" ||
      msg.body.toLowerCase() === "bye"
    ) {
